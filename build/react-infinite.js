...
var Infinite = React.createClass({
  ...
  getDefaultProps: function getDefaultProps() {
    return {
      ...
      refCustomScrollContainer: function refCustomScrollContainer() {
        return {};
      },
  ...
  generateComputedUtilityFunctions: function generateComputedUtilityFunctions(props) {
    ...
    if (props.useWindowAsScrollContainer) {
      ...
      (function () {
        var getContainer = props.refCustomScrollContainer;
        utilities.subscribeToScrollListener = function () {
          getContainer().addEventListener('scroll', _this.infiniteHandleScroll);
        };
        utilities.unsubscribeFromScrollListener = function () {
          getContainer().removeEventListener('scroll', _this.infiniteHandleScroll);
        };
        utilities.getScrollTop = function () {
